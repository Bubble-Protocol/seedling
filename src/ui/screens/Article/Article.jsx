...
export const Article = () => {
  ...
  const isAuthor = (walletConnected && user.account) && 
    ((user.username === article.author.username) || (article.author.address && (user.account.toLowerCase() === article.author.address.toLowerCase())));
